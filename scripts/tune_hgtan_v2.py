...
CANDIDATES = [
    ...
    {
        "name": "v2_noreliability_robust_strong",
        "model": "TemporalHGTANV2_NoReliability",
        "prefix_weight": 1.0,
        "ordinal_weight": 0.0,
        "noise_std": 0.02,
    ...
    {
        "name": "v2_nosynergy_robust_strong",
        "model": "TemporalHGTANV2_NoSynergy",
        "prefix_weight": 1.0,
        "ordinal_weight": 0.0,
        "noise_std": 0.02,
    ...
    {
        "name": "core_notemporal_robust_light",
        "model": "TemporalHGTANV2_CoreNoTemporal",
        "prefix_weight": 1.0,
        "ordinal_weight": 0.0,
        "noise_std": 0.01,
        "frame_drop_prob": 0.03,
    ...
    {
        "name": "core_nogrouping_robust_light",
        "model": "TemporalHGTANV2_CoreNoGrouping",
        "prefix_weight": 1.0,
        "ordinal_weight": 0.0,
        "noise_std": 0.01,
        "frame_drop_prob": 0.03,
