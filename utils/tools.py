...
CLI_OVERRIDE_MAP = {
    ...
    "urgency_weight": ("train", "urgency_weight"),
    "threat_weight": ("train", "threat_weight"),
    "label_smoothing": ("train", "label_smoothing"),
    "mixup_alpha": ("train", "mixup_alpha"),
    "loss_type_threat": ("train", "loss_type_threat"),
    "loss_type_urgency": ("train", "loss_type_urgency"),
    "focal_gamma": ("train", "focal_gamma"),
    "class_weight_max": ("train", "class_weight_max"),
    "use_mixup": ("train", "use_mixup"),
    ...
    "prior_weight_alpha": ("model", "prior_weight_alpha"),
    "use_prior_weights": ("model", "use_prior_weights"),
    ...
    "track_missing_ratio": ("sequence", "track_missing_ratio"),
    "track_jitter_std": ("sequence", "track_jitter_std"),
